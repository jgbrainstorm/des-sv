...
os.system('tar -czf hexpod_parameter_'+date+'-MJD-'+mjd+'.tar.gz hexapod_position_*.txt')
os.system('tar -czf fwhm_whisker_'+date+'-MJD-'+mjd+'.tar.gz fwhm_*.txt whisker_*.txt')
