...
if __name__ == "__main__":
    ...
    pl.plot(fwhmQR[idxg],fwhmIH[idxg],'go',label='g')
    pl.plot(fwhmQR[idxr],fwhmIH[idxr],'ro',label='r')
    pl.plot(fwhmQR[idxi],fwhmIH[idxi],'co',label='i')
    pl.plot(fwhmQR[idxz],fwhmIH[idxz],'mo',label='z')
    pl.plot(fwhmQR[idxY],fwhmIH[idxY],'bo',label='Y')
    pl.grid()
    ...
    pl.close()
    pl.figure(figsize=(10,10))
    pl.plot(ellipQR[idxg],ellipIH[idxg],'go',label='g')
    pl.plot(ellipQR[idxr],ellipIH[idxr],'ro',label='r')
    pl.plot(ellipQR[idxi],ellipIH[idxi],'co',label='i')
    pl.plot(ellipQR[idxz],ellipIH[idxz],'mo',label='z')
    pl.plot(ellipQR[idxY],ellipIH[idxY],'bo',label='Y')
    pl.grid()
